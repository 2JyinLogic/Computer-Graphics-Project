...
TextureLoader::TextureLoader(int num)
{
...
void TextureLoader::loadTGA(const char* filename)
{
...
void TextureLoader::loadGLSkyboxTextures(const char* filename, Texture tex)
{
...
void TextureLoader::loadGLTextures(const char * filename, Texture tex) {// Load bitmaps And Convert To Textures
